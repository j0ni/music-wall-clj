(ns user
  (:require [clojure.repl :refer :all]
            ...
            [music-wall.system :as system]))

(def dev-config
  {:app {:middleware [wrap-stacktrace]}
   :figwheel
   {:css-dirs ["resources/music_wall/public/css"]
    :builds   [{:source-paths ["src" "dev"]
                :build-options
                {:optimizations :none
                 :main "cljs.user"
                 :asset-path "/js"
                 :output-to  "target/figwheel/music_wall/public/js/main.js"
                 :output-dir "target/figwheel/music_wall/public/js"
                 :source-map true
                 :source-map-path "/js"}}]}})
